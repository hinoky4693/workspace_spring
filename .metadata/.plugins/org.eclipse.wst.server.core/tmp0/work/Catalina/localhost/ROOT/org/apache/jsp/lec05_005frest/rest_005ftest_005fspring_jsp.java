 ...
 * Generated at: 2024-06-17 08:43:27 UTC
...
public final class rest_005ftest_005fspring_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<input type=\"button\" id=\"string_json\" value=\"String -> JSON\"><hr>\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("REST Test6<hr>\r\n");
      out.write("6. 일반적형태(String -> JSON) <br>\r\n");
      out.write("<form id=\"regForm\">\r\n");
      out.write("<input type=\"text\" id=\"title\" name=\"title\" value=\"title\">\r\n");
      out.write("<input type=\"text\" id=\"regid\" name=\"regid\" value=\"regid\">\r\n");
      out.write("<input type=\"button\" id=\"writeButton\" value=\"글쓰기\"><hr>\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
      out.write("REST Test7<hr>\r\n");
      out.write("7. RESTCONTROLLER (String -> String) <br>\r\n");
      out.write("<input type=\"text\" id=\"ename6\" name=\"ename6\">\r\n");
      out.write("<input type=\"button\" id=\"rest_string_string\" value=\"RestController\"><hr>\r\n");
      out.write("\r\n");
      ...
      out.write("	        url         : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/ctl_str_str2\",\r\n");
      out.write("	        data 		: \"ename=\"+ename2,\r\n");
      out.write("	  		error 	    : function(myval){ console.log(\"에러:\" + myval);   },\r\n");
      out.write("	  		success     : function(myval){\r\n");
      out.write("	  										console.log(\"1. Spring 응답 : \" + myval);\r\n");
      out.write("	  									 }\r\n");
      out.write("		});\r\n");
      out.write("	});\r\n");
      out.write("\r\n");
      ...
      out.write("	        url         : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/ctl_json_str\",\r\n");
      out.write("	        data		: JSON.stringify(objData),\r\n");
      out.write("	        contentType : \"application/json; charset=UTF-8\",\r\n");
      out.write("	  		error 	    : function(myval){ console.log(\"에러:\" + myval);   },\r\n");
      out.write("	  		success     : function(myval){ \r\n");
      out.write("	  										console.log(\"2. Spring 응답 : \" + myval);\r\n");
      out.write("	  									 }\r\n");
      out.write("		});\r\n");
      out.write("	});\r\n");
      out.write("	\r\n");
      ...
      out.write("	        url         : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/ctl_str_json\",\r\n");
      out.write("	        data 		: \"ename=\"+ename4,\r\n");
      out.write("	  		error 	    : function(myval){ console.log(\"에러:\" + myval);   },\r\n");
      out.write("	  		success     : function(myval, textStatus, xhr){ \r\n");
      out.write("	  								if (xhr.status == 200){\r\n");
      out.write("										console.log(\"3. Spring 응답 : \" + myval[\"message\"]);		  									\r\n");
      out.write("	  								}\r\n");
      out.write("						 }\r\n");
      out.write("		});\r\n");
      out.write("	});\r\n");
      ...
      out.write("	        url         : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/ctl_json_json\",\r\n");
      out.write("	        data 		: JSON.stringify(objData),\r\n");
      out.write("	        contentType : \"application/json; charset=UTF-8\",\r\n");
      out.write("	  		error 	    : function(myval){ console.log(\"에러:\" + myval);   },\r\n");
      out.write("	  		success     : function(myval){ \r\n");
      out.write("	  										console.log(\"4. Spring 응답 : \" + myval[\"message\"]);		\r\n");
      out.write("	  									 }\r\n");
      out.write("		});\r\n");
      out.write("	});\r\n");
      out.write("	\r\n");
      out.write("	$(\"#writeButton\").click(  function(){\r\n");
      out.write("		var sendFormData = $(\"#regForm\").serialize(); // title=aaaa&regid=kim\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			method      : \"POST\",\r\n");
      out.write("	        url         : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/ctl_normal\",\r\n");
      ...
      out.write("	});\r\n");
      out.write("	\r\n");
      out.write("	$(\"#rest_string_string\").click(  function(){\r\n");
      out.write("		var ename6 = $(\"#ename6\").val();\r\n");
      out.write("		\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			method      : \"POST\",\r\n");
      out.write("	        url         : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/restctl_str_str\",\r\n");
      out.write("	        data 		: \"ename=\"+ename6,\r\n");
      out.write("	  		error 	    : function(myval){ console.log(\"에러:\" + myval);   },\r\n");
      out.write("	  		success     : function(myval){\r\n");
      out.write("	  										console.log(\"0. RestController 응답 : \" + myval);\r\n");
      out.write("	  									 }\r\n");
      out.write("		});\r\n");
      out.write("	});\r\n");
      out.write("	\r\n");
